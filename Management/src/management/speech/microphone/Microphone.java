package management.speech.microphone;
 ...
 * @see https://github.com/lkuza2/java-speech-api/blob/master/src/main/java/com/darkprograms/speech/microphone/Microphone.java
 *
 */
public class Microphone implements Closeable {
   ...
   *
   * @return PROCESSING_AUDIO is returned when the Thread is recording Audio and/or saving it to a
   *         file<br>
